...
function VerifyOTPScreen({ navigation, route }) {
    ...
    const handleProceed = () => {
        if (!pin1 || pin1 === '' || !pin2 || pin2 === '' || !pin3 || pin3 === '' || !pin4 || pin4 === '' || !pin5 || pin5 === '' || !pin6 || pin6 === '') return alert("Please enter correct OTP");
    ...
    return (
        <View style={styles.container}>
            <AppBackHeader text="Back" color={colors.primary} destination={routes.AUTHENTICATION} destinationObject={details} />
            <View style={styles.titleContainer}>
                <Text style={styles.title}>VERIFY OTP</Text>
                <View style={styles.messageContainer}>
                    <Text style={styles.message}>Enter the 6-digit OTP sent to you at</Text>
            ...
            <View style={styles.innerInputContainer}>
                <OtpField inputRef={ref1} nextDigitRef={ref2} digit={pin1} setDigit={setPin1} />
                <OtpField inputRef={ref2} nextDigitRef={ref3} digit={pin2} setDigit={setPin2} />
                <OtpField inputRef={ref3} nextDigitRef={ref4} digit={pin3} setDigit={setPin3} />
                <OtpField inputRef={ref4} nextDigitRef={ref5} digit={pin4} setDigit={setPin4} />
                <OtpField inputRef={ref5} nextDigitRef={ref6} digit={pin5} setDigit={setPin5} />
            ...
            <View style={styles.verifyButtonContainer}>
                <TouchableOpacity activeOpacity={0.9} style={styles.buttonContinue} onPress={handleProceed} >
